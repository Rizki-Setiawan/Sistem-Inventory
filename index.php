...
$sql="SELECT * FROM pengguna where id_pengguna='$user'";
...
<head>
  ...
  <title>Sistem Inventory Digital</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?page=supplier"><i class="fa fa-truck"></i><span>Supplier</span></a></li>
        <li><a href="index.php?page=customer"><i class="fa fa-group"></i><span>Customer</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=transaksi_masuk"><i class="fa fa-arrow-circle-down "></i>Transaksi Masuk</a></li>
            <li><a href="index.php?page=transaksi_keluar"><i class="fa fa-arrow-circle-up "></i>Transaksi Keluar</a></li>
          </ul>
        </li>
         <li>
